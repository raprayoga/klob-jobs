...
const buttonVariants = cva(
  'lg:px-4 lg:py-2 px-2 py-1 flex items-center justify-center text-center lg:text-sm text-xs rounded cursor-pointer disabled:cursor-default transition-colors',
  {
    variants: {
      theme: {
        'light-gray': 'bg-light-gray text-white hover:opacity-90',
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, theme, isDisabled, isLoading, ...props }, ref) => {
    return (
      <button
