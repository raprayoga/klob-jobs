...
This application is a simple job vacancy app, a simple app to send see vacancy & send the application
This application is consists of feature like menu job vacancy list, send application, cancel application, creat vacancy
This application is a technical test application for hiring process
You can visit the app [here](https://klob-jobs.vercel.app/) too.
